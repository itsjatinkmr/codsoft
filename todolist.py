...
root = Tk()
root.title('JATIN TO-DO LIST')
root.geometry('1100x500')
root.config(bg="khaki")

#########################         Heading Label

Label(root, text='JATIN To-Do List', bg='skyblue', font=("castellar", 25,'bold'), wraplength=1100).place(x=600, y=0)

####################              Listbox with all the tasks with a Scrollbar
tasks = Listbox(root, selectbackground='brown', bg='pink', font=('Helvetica', 22), height=22, width=55)
