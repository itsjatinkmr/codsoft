...
frame = tk.Frame(root, padx=25, pady=30,bg='skyblue')
question_label = tk.Label(frame,height=5, width=38,bg='brown',fg="white", 
...
option1 = tk.Radiobutton(frame, bg="skyblue", variable=v1, font=('Verdana', 20),
                         command = lambda : checkAnswer(option1))
option2 = tk.Radiobutton(frame, bg="skyblue", variable=v2, font=('Verdana', 20), 
                         command = lambda : checkAnswer(option2))
option3 = tk.Radiobutton(frame, bg="skyblue", variable=v3, font=('Verdana', 20), 
                         command = lambda : checkAnswer(option3))
option4 = tk.Radiobutton(frame, bg="skyblue", variable=v4, font=('Verdana', 20), 
